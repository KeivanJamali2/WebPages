...
def get_jalali_weekday(date_input, lang='fa'):
    """
    Get weekday name for a date.
    
    Args:
        date_input: datetime.date object, jdatetime.date object, or jdatetime.datetime object
    ...
    # If it's already a jdatetime object, use it directly
    if isinstance(date_input, (jdatetime.date, jdatetime.datetime)):
        j_date = date_input
    else:
        # Otherwise, convert from Gregorian to Jalali
        j_date = gregorian_to_jalali(date_input)
