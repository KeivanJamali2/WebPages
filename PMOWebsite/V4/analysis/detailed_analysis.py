...
class DetailedAnalysisEngine:
    ...
    def get_schedule_variance(self):
        ...
        try:
            ...
            return {
                ...
                'data': {
                    'sv': round(data.get('sv', 0), 0),
                    'spi': round(data.get('spi', 1), 2),
                    'planned_value': round(data.get('planned_value', 0), 0),
                    'earned_value': round(data.get('earned_value', 0), 0),
    ...
    def get_issue_frequency(self):
        ...
        try:
            data = self.issues.get_issue_frequency()
            ...
            return {
                ...
                'data': {
                    ...
                    'average_per_month': round(data.get('average_per_month', 0), 1)
                }
            }
        except Exception as e:
    ...
    def get_problem_locations(self):
        ...
        try:
            data = self.issues.get_problem_locations()
            ...
            return {
                ...
                'data': {
                    ...
                    'labels': [l['location'] for l in locations[:10]],
                    'values': [l['issue_count'] for l in locations[:10]],
    ...
    def get_issue_duration(self):
        ...
        try:
            ...
            return {
                ...
                'data': {
                    'average_duration_hours': round(data.get('average_duration', 0), 1),
    ...
    def get_cpi_analysis(self):
        ...
        try:
            data = self.kpi.get_summary()
            performance = data.get('performance_indices', {}).get('current', {})
            ...
            return {
                ...
                'data': {
                    'cpi': round(cpi, 2),
                    'ev': round(performance.get('ev', 0), 0),
                    'ac': round(performance.get('ac', 0), 0),
                    'interpretation': interpretation,
                    'formula': 'CPI = EV / AC',
        ...
        try:
            ...
            return {
                ...
                'data': {
                    'spi': round(spi, 2),
                    'ev': round(performance.get('ev', 0), 0),
                    'pv': round(performance.get('pv', 0), 0),
                    'interpretation': interpretation,
                    'formula': 'SPI = EV / PV',
    ...
    def get_burn_rate(self):
        ...
        try:
            ...
            return {
                ...
                'data': {
                    'daily_burn': round(burn.get('daily', 0), 0),
                    'weekly_burn': round(burn.get('daily', 0) * 7, 0),
                    'monthly_burn': round(burn.get('daily', 0) * 30, 0),
                    'total_spent': round(burn.get('total_spent', 0), 0),
                    'total_budget': round(burn.get('budget', 0), 0),
                    'percent_burned': round(burn.get('percent_burned', 0), 1),
                    'days_elapsed': burn.get('days_elapsed', 0)
                }
            }
        except Exception as e:
    ...
    def get_days_to_completion(self):
        ...
        try:
            ...
            return {
                ...
                'data': {
                    'days_remaining': completion.get('days_remaining', 0),
                    'estimated_date': estimated_date,
                    'confidence': confidence,
                    'progress_percent': round(completion.get('progress_percent', 0), 1),
                    'velocity': round(completion.get('daily_velocity', 0), 2)
                }
            }
        except Exception as e:
