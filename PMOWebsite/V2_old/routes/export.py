...
def create_single_form_workbook(form):
    ...
    for op in form.construction_operations:
        ...
        ws.cell(row=current_row, column=1).alignment = right_align
        ws.cell(row=current_row, column=2, value=op.start_km).border = thin_border
        ws.cell(row=current_row, column=2).alignment = center_align
        ws.cell(row=current_row, column=3, value=op.end_km).border = thin_border
        ws.cell(row=current_row, column=3).alignment = center_align
        ws.cell(row=current_row, column=4, value=op.unit or '').border = thin_border
        ws.cell(row=current_row, column=4).alignment = center_align
        ws.cell(row=current_row, column=5, value=op.progress).border = thin_border
        ws.cell(row=current_row, column=5).alignment = center_align
        ws.cell(row=current_row, column=6, value=op.map_number or '').border = thin_border
    ...
    for mat in form.incoming_materials:
        ...
        ws.cell(row=current_row, column=2).alignment = center_align
        ws.cell(row=current_row, column=3, value=mat.cumulative_incoming).border = thin_border
        ws.cell(row=current_row, column=3).alignment = center_align
        ws.cell(row=current_row, column=4, value=mat.used_amount).border = thin_border
        ws.cell(row=current_row, column=4).alignment = center_align
        ws.cell(row=current_row, column=5, value=mat.cumulative_used).border = thin_border
        ws.cell(row=current_row, column=5).alignment = center_align
        ws.cell(row=current_row, column=6, value=mat.storage_place or '').border = thin_border
        ws.cell(row=current_row, column=6).alignment = center_align
        ws.cell(row=current_row, column=7, value=mat.waybill_number or '').border = thin_border
    ...
    for issue in form.project_issues:
        ...
        ws.cell(row=current_row, column=2).alignment = center_align
        ws.cell(row=current_row, column=3, value=issue.location_km or '').border = thin_border
        ws.cell(row=current_row, column=3).alignment = center_align
