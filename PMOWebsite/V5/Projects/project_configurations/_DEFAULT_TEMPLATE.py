...
HUMAN_RESOURCES_RATES = {
    "مدیر پروژه": {"total_days": 0},  # TODO: Fill days
    "سرپرست کارگاه": {"total_days": 0},
    "معاونت اجراء": {"total_days": 0},
    "مسئول اجرا": {"total_days": 0},
    "مسئول ابنیه فنی": {"total_days": 0},
    "سرپرست دفتر فنی": {"total_days": 0},
    "سرپرست دفترفنی": {"total_days": 0},
    "کارشناس دفتر فنی": {"total_days": 0},
    "نقشه بردار": {"total_days": 0},
    "کمک نقشه بردار": {"total_days": 0},
    "مباشر عملیات خاکی": {"total_days": 0},
    "مباشر": {"total_days": 0},
    "مسئول کنترل پروژه": {"total_days": 0},
    "کنترل پروژه": {"total_days": 0},
    "اداری- مالی": {"total_days": 0},
    "اداری-مالی": {"total_days": 0},
    "حسابدار": {"total_days": 0},
    "کارپرداز": {"total_days": 0},
    "تدارکات": {"total_days": 0},
    "کارشناس ایمنی": {"total_days": 0},
    "مسئول ایمنی": {"total_days": 0},
    "افسر ایمنی": {"total_days": 0},
    "مسئول HSE": {"total_days": 0},
    "سرپرست ماشین آلات": {"total_days": 0},
    "مسئول ماشین آلات": {"total_days": 0},
    "کارشناس نت ماشین آلات": {"total_days": 0},
    "راننده سنگین": {"total_days": 0},
    "راننده ماشین سنگین": {"total_days": 0},
    "راننده ویژه": {"total_days": 0},
    "راننده سبک": {"total_days": 0},
    "راننده سواری و وانت": {"total_days": 0},
    "راننده گریدر": {"total_days": 0},
    "راننده لودر": {"total_days": 0},
    "راننده بیل": {"total_days": 0},
    "راننده غلطک": {"total_days": 0},
    "راننده کامیون": {"total_days": 0},
    "راننده جرثقیل": {"total_days": 0},
    "راننده آبپاش": {"total_days": 0},
    "راننده میکسر": {"total_days": 0},
    "راننده جارو": {"total_days": 0},
    "راننده کمرشکن": {"total_days": 0},
    "مکانیک": {"total_days": 0},
    "سرویس کار": {"total_days": 0},
    "انباردار": {"total_days": 0},
    "مسئول حراست": {"total_days": 0},
    "نگهبان": {"total_days": 0},
    "مسئول امور داخلی": {"total_days": 0},
    "امور داخلی کارگاه": {"total_days": 0},
    "مسئول پشتیبانی": {"total_days": 0},
    "تاسیسات": {"total_days": 0},
    "برقکار": {"total_days": 0},
    "برق کار (ماشین آلات)": {"total_days": 0},
    "استاد کار بنایی": {"total_days": 0},
    "بنا": {"total_days": 0},
    "کارگر": {"total_days": 0},
    "کارگر ساده": {"total_days": 0},
    "کارگر گریدر": {"total_days": 0},
    "بتن ریز": {"total_days": 0},
    "جوشکار": {"total_days": 0},
    "آرماتوربند": {"total_days": 0},
    "قالب بند": {"total_days": 0},
    "عایق کار": {"total_days": 0},
    "خدمات": {"total_days": 0},
    "کنترلچی": {"total_days": 0},
    "تکنسین آزمایشگاه": {"total_days": 0},
    "کارگر آزمایشگاه": {"total_days": 0},
    "نصاب ساندویچ پنل": {"total_days": 0},
    "اکیپ تاسیسات برق": {"total_days": 0},
    "اکیپ آسفالت": {"total_days": 0},
    "اپراتور بچینگ": {"total_days": 0},
}
...
# =============================================================================
MATERIAL_PRICES = {
    "شن و ماسه": {"unit": "تن (ton)", "price_per_unit": 0, "planned_total": 0},  # TODO: Fill values
    "شن و ماسه و بادامی": {"unit": "تن (ton)", "price_per_unit": 0, "planned_total": 0},
    "آسفالت": {"unit": "تن (ton)", "price_per_unit": 0, "planned_total": 0},
    "بتن آماده": {"unit": "متر مکعب (m³)", "price_per_unit": 0, "planned_total": 0},
    "آجر": {"unit": "تعداد", "price_per_unit": 0, "planned_total": 0},
    "آهن آلات": {"unit": "کیلوگرم (kg)", "price_per_unit": 0, "planned_total": 0},
    "سیمان": {"unit": "تن (ton)", "price_per_unit": 0, "planned_total": 0},
    "ماسه بادی": {"unit": "تن (ton)", "price_per_unit": 0, "planned_total": 0},
    "ماسه شکسته": {"unit": "تن (ton)", "price_per_unit": 0, "planned_total": 0},
