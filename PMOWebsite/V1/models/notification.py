...
class Notification(db.Model):
    ...
    def create_form_submitted_notification(admin_users, form):
        ...
        for admin in admin_users:
            notification = Notification(
                ...
                message=f'A new daily form ({form.document_code}) has been submitted by {form.submitted_by_user.username} and needs review.',
    ...
    def create_form_approved_notification(form):
        ...
        return Notification(
            ...
            title='Form Approved',
            message=f'Your daily form ({form.document_code}) has been approved.',
            related_form_id=form.id
        )
    ...
    def create_form_rejected_notification(form, comment):
        ...
        return Notification(
            ...
            title='Form Rejected',
            message=f'Your daily form ({form.document_code}) has been rejected. Reason: {comment}',
            related_form_id=form.id
        )
