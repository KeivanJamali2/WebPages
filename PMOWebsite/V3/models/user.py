...
class User(db.Model):
    ...
    username = db.Column(db.String(80), unique=True, nullable=False)  # English username
    username_persian = db.Column(db.String(80), unique=True, nullable=True)  # Persian username
    ...
    def get_display_name(self, lang='en'):
        """Get the appropriate username based on language."""
        if lang == 'fa' and self.username_persian:
            return self.username_persian
    ...
    def to_dict(self):
        return {
            ...
            'username_persian': self.username_persian,
